...
> ⚠️ **ВНИМАНИЕ — v2.1: логика переводов сильно изменилась.**
...
>
> **Перед первым запуском перевода в v2.1 выполни:**
> ```
...
| **Полная очистка v2.1** (все моды + CSV новый/legacy + весь кэш + оверлеи + EN-бэкапы) | `./revert_mods.bat --full-clean` |
