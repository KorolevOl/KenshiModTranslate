...
> ⚠️ **ВНИМАНИЕ — v1.8: логика переводов сильно изменилась.**
> В этой версии отбор «переводить/не переводить» строки стал **по object-ID из `.po`**,
> а не по тексту. Старый кэш (state/*, CSV, оверлеи), накопленный в v1.7 и раньше,
> **настроен под старую логику и может «отравлять» новый перевод**.
>
> **Перед первым запуском перевода в v1.8 выполни:**
> ```
